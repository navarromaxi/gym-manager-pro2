...
import {
  pickRelevantPlanContract,
  type RawPlanContract,
} from "@/features/payments/plan-contract-utils";
import {
  calculatePlanEndDate,
  findLatestPlanPaymentDate,
  formatDueDate,
  getEffectivePaymentDate,
  getPaymentReferenceType,
  getPlanPrice,
  parseDueDate,
  parseLocalDate,
...
import {
  hasConfigValue,
  mapPaymentMethodToFacturaPaymentType,
  normalizeFacturaEnvironment,
  sanitizeConfigString,
  sanitizeInvoiceText,
  toNumberOrNull,
} from "@/features/payments/invoice-config-utils";
...
export function PaymentManagement({
  ...
  const revertMemberAfterPlanDeletion = async (
    ...
    if (removedPayment.start_date) {
      const planPrice = getPlanPrice(removedPayment, members, plans);
